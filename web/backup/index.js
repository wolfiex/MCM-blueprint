...
function init() {
  ...
  renderer = new THREE.WebGLRenderer({antialias:true,precision:'highhp'});
  ...
  async function lines(e, z, v) {
      ...
      g.name = v;
      console.log("load");
      varrxn = Object.keys(e.rxns).filter(k => e.rxns[k][v] > 0);
